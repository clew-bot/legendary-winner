      ...
      <CardContent className="jisho">
        ...
        <div className={classes.centerme}>
          ...
          <Typography className={classes.pos} color="textPrimary">
            ...
            be working out at home. This application will help keep logs of
            workouts such as reps, weights, and distance just to start.
          </Typography>
          <Typography>
            <br></br>
            <h2>
          ...
          <Typography>
            ...
            <a
              className="atag"
              href="https://glacial-lake-51559.herokuapp.com/"
            >
              <svg
                viewBox="0 0 15 15"
                fill="none"
