...
export default function ClewbotDexCard() {
      ...
      <CardContent className="jisho">
        ...
        <div className={classes.centerme}>
          ...
          <Typography className={classes.pos} color="textPrimary">
            ...
            the future or have read. Save your books with a name, author, and
            synopsis and data will be saved through Atlas.
          </Typography>
          <Typography>
            <br></br>
            <h2>
            ...
            <br></br>
            <img
              src="./assets/images/reactreading.png"
              alt="React reading list"
              height="300px"
          ...
          <Typography>
            {/* <a className="atag" href="https://github.com/clew-bot/super-giggle">
              <svg
                viewBox="0 0 15 15"
                fill="none"
            ...
            <a
              className="atag"
              href="https://gentle-fortress-70701.herokuapp.com/"
            >
              <svg
                viewBox="0 0 15 15"
                fill="none"
