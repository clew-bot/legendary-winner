...
export default function NutriSpot() {
      ...
      <CardContent className="jisho">
        ...
        <div className={classes.centerme}>
          ...
          <Typography className={classes.pos} color="textPrimary">
            ...
            Additionally, Nutri Spot uses data retrieved from Spoonacular and
            incorporates Yelp’s API to display nearby restaurants that serve
            similar dishes.
          </Typography>
          <Typography>
            <br></br>
          ...
          <Typography>
            <a className="atag" href="https://github.com/jdmarty/scoop">
              <svg
                viewBox="0 0 15 15"
                fill="none"
            ...
            <br />
            <a className="atag" href="https://jdmarty.github.io/scoop/">
              <svg
                viewBox="0 0 15 15"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
