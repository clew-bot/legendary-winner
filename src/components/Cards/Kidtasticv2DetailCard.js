...
export default function Kidtasticv2DetailCard() {
      ...
      <CardContent className="jisho">
        ...
        <div className={classes.centerme}>
          ...
          <Typography className={classes.pos} color="textPrimary">
            ...
            as the main templating framework, with mySQL running on the backend.
          </Typography>
          <Typography>
            <br></br>
            <h2>
            ...
            <br></br>
            <br></br>
            <img src="./assets/images/kidv1.png" alt="jerry" height="300px" />
            <br></br>
            <br></br>
            <br></br>
          </Typography>
